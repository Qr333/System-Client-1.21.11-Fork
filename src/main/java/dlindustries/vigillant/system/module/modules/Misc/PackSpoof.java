package dlindustries.vigillant.system.module.modules.Misc;
...
public class PackSpoof extends Module implements PacketReceiveListener {
    public PackSpoof() {
        super(EncryptedString.of("Pack Optimizer"), EncryptedString.of("Ignores custom resource packs enforced by servers"), -1, Category.Misc);
    }
    @Override
