...
public final class ClickGUI extends Module implements PacketReceiveListener {
    ...
    public enum Theme {
        PURPLE("Purple"), RED("Red"), PINK("Pink"), BLUE("Light blue"),
        GREEN("Green"), YELLOW("Yellow"), WHITE("White"), RAINBOW("Rainbow"),
        CUSTOM("Custom");
    ...
    public static final ModeSetting<Theme> theme = new ModeSetting<>(
            EncryptedString.of("Theme"), Theme.PURPLE, Theme.class)
            .setDescription(EncryptedString.of("Color theme for the GUI and ESP"));

    public static final BooleanSetting useCustomColor = new BooleanSetting(EncryptedString.of("Custom Color"), false)
            .setDescription(EncryptedString.of("Use a custom accent color instead of the theme"));

    public static final ColorSetting accentColor = new ColorSetting("Accent Color", new Color(120, 80, 255));
    ...
    public static final ModeSetting<AnimationMode> animationMode = new ModeSetting<>(
            EncryptedString.of("Animations"), AnimationMode.Normal, AnimationMode.class);
    ...
    public ClickGUI() {
        ...
        green.setValue(10);
        blue.setValue(50);
        addSettings(alphaWindow, breathing, background, backgroundAlpha, backgroundImage, blur,
                theme, useCustomColor, accentColor,
